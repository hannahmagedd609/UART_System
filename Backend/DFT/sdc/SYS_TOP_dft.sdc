...
# Created by write_sdc on Wed Oct 23 23:45:54 2024
...
group_path -name INOUT  -from [list [get_ports RST_N] [get_ports UART_CLK] [get_ports REF_CLK] [get_ports UART_RX_IN] [get_ports {SI[3]}] [get_ports {SI[2]}] [get_ports {SI[1]}] [get_ports {SI[0]}] [get_ports SE] [get_ports Test_Mode] [get_ports scan_clk] [get_ports scan_rst]]  -to [list [get_ports {SO[3]}] [get_ports {SO[2]}] [get_ports {SO[1]}] [get_ports {SO[0]}] [get_ports UART_TX_O] [get_ports parity_error] [get_ports framing_error]]
group_path -name INREG  -from [list [get_ports RST_N] [get_ports UART_CLK] [get_ports REF_CLK] [get_ports UART_RX_IN] [get_ports {SI[3]}] [get_ports {SI[2]}] [get_ports {SI[1]}] [get_ports {SI[0]}] [get_ports SE] [get_ports Test_Mode] [get_ports scan_clk] [get_ports scan_rst]]
...
set_input_delay -clock DFTCLK  4  [get_ports {SI[3]}]
set_input_delay -clock DFTCLK  4  [get_ports {SI[2]}]
set_input_delay -clock DFTCLK  4  [get_ports {SI[1]}]
set_input_delay -clock DFTCLK  4  [get_ports {SI[0]}]
set_input_delay -clock DFTCLK  4  [get_ports SE]
set_input_delay -clock DFTCLK  4  [get_ports Test_Mode]
set_output_delay -clock DFTCLK  4  [get_ports {SO[3]}]
set_output_delay -clock DFTCLK  4  [get_ports {SO[2]}]
set_output_delay -clock DFTCLK  4  [get_ports {SO[1]}]
set_output_delay -clock DFTCLK  4  [get_ports {SO[0]}]
...
set_clock_groups -asynchronous -name REF_CLK_1 -group [list [get_clocks REF_CLK] [get_clocks ALU_CLK]] -group [list [get_clocks UART_CLK] [get_clocks TX_CLK] [get_clocks RX_CLK]] -group [get_clocks DFTCLK]
